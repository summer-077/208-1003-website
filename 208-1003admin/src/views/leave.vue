	...
	<div>
		<el-form :inline="true" :model="dataForm" :rules="dataRule" ref="dataForm">
			...
			<el-form-item>
				...
				<el-button type="danger" size="medium" @click.native="addHandle()">我要请假</el-button>
			</el-form-item>
		</el-form>
		<el-table
			:data="dataList"
		...
		>
			<el-table-column width="40px" prop="reason" header-align="center" align="center" type="expand">
				<template #default="scope">
					...
					<el-form-item>请假原因：{{ scope.row.reason }}</el-form-item>
					<br>
					<span v-if="scope.row.status == '不同意'">驳回理由：{{ scope.row.reject }}</span>
				</template>
			</el-table-column>
		...
		></el-pagination>
		<leave-add v-if="addVisible" :taskId="taskId" ref="add" @refreshDataList="loadDataList"></leave-add>
...
export default {
	components: { LeaveAdd, LeavePdf,refuse ,approval},
	props:{
    taskId:null,
	},
	data: function() {
