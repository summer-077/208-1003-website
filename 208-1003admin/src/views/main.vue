        ...
        <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
            <div class="site-navbar__header">
                <h1 class="site-navbar__brand">
                    <a class="site-navbar__brand-lg">物流信息管理系统</a>
            ...
            <div class="site-sidebar__inner">
                ...
                >
                    ...
                    <el-submenu index="在线办公" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
                        ...
                        <el-menu-item index="homework" @click="$router.push({ name: 'homework' })">
                            <SvgIcon name="bianji" class="icon-svg" />
                            <span slot="title">文件上传</span>
                        </el-menu-item>
                        <el-menu-item index="homework" @click="$router.push({ name: 'editor' })">
                            <SvgIcon name="bianji" class="icon-svg" />
